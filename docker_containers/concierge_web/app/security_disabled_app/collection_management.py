...
from ..common.doc_link import doc_link
...
@module.ui
def document_ui(collection_id: str, doc: DocumentInfo):
    card_elements = [
        ui.markdown(
            f"""
...
def document_server(
    ...
    async def delete():
        return await client.delete_document(collection_id, doc.type, doc.document_id)
